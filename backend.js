...
const student1 = new Student("Sayooj","koroth", 45, 53,72, 63, 81, 49);
const student2 = new Student("Sayooj","t", 145, 153,172, 63, 81, 49);

console.log(student2.displayGrade());;

import {link, requestCall} from './utils/ServerRequest.js';
